              ...
              <div class="card card-table">
                <div class="card-body">
                      <div class="pricing-table pricing-table-primary">
                        ...
                        <div class="pricing-table-title"><?php echo $userArr['user_first_name']; ?></div>
                        <div class="pricing-table-title"><?php echo $userArr['user_last_name']; ?></div>
                        <div class="card-divider card-divider-xl"></div>
                        <div class="pricing-table-title"><?php echo $userArr['user_email']; ?></div>
                      </div>
                </div>
              </div>
            </div>
