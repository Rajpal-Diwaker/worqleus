                            ...
                            <div class="col-sm-12">
                                <table class="table table-striped table-hover table-fw-widget dataTable" id="table1" role="grid" aria-describedby="table1_info">
                                  <thead>
                                    <tr>
                                      <th><span>S/N</span></th>
                                      <th data-action="sort" data-title="post_title" data-direction="ASC"><span>Post Title</span> <i class="glyphicon glyphicon-triangle-bottom"></i></th>
                                      <th data-action="sort" data-title="post_content" data-direction="ASC"><span>Post Content</span> <i class="glyphicon glyphicon-triangle-bottom"></i></th>
                                      <th>Category</th>
                                      <th>Action</th>
                                    </tr>
                                  </thead>
                                        ...
                                        foreach ($postlist as $key => $value) {
                                          ...
                                          <tr>
                                              ...
                                              <td  style="text-align:center;" class="allbutton"><?php if ($value->post_status==='inactive') { ?>
                                                <a class="btn btn-danger" onclick="changeStatus(<?php echo $value->post_id.','.'1';?>)">Active</a>
                                                <?php } else { ?>
                                                <a class="btn btn-info" onclick="changeStatus(<?php echo $value->post_id.','.'0';?>)">Inactive</a>
                                                <?php } ?>
                                                
                                                <a class="" href="<?php echo(ADMINURL.'Content/editPost/').urlencode(base64_encode($value->post_id)); ?>"><span class="mdi mdi-edit">
                                                </span></a>
                                                <a class="" href="<?php echo(ADMINURL.'Content/viewPost/').urlencode(base64_encode($value->post_id)); ?>"><span class="mdi mdi-eye"></span></a>
                                              </td>
                                          </tr>
                                      <?php }
                                      ?>
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/bootbox.js/4.2.0/bootbox.min.js" type="text/javascript"></script>
  <script type="text/javascript">
    ...
    //  var url = '<?=base_url('backoffice/Content/post_management')?>?query='+searchKey+'&limitRows='+limitRows+'&orderField='+curOrderField+'&orderDirection='+curOrderDirection;
    //  console.log(url);
      window.location.href = '<?=base_url('backoffice/Content/post_management')?>?query='+searchKey+'&limitRows='+limitRows+'&orderField='+curOrderField+'&orderDirection='+curOrderDirection;
    }
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer" style="border:0px!important; text-align: center;">
        <a class="btn btn-default" href="<?php echo(ADMINURL.'Content/post_management'); ?>">OK</a>
      </div>
    </div>
